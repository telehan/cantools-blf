...
PRE_UNINSTALL = :
POST_UNINSTALL = :
build_triplet = x86_64-apple-darwin17.3.0
host_triplet = x86_64-apple-darwin17.3.0
...
libcanblf_la_LIBADD =
am_libcanblf_la_OBJECTS = src/libcanblf/libcanblf_la-blfreader.lo \
	src/libcanblf/libcanblf_la-blfparser.lo \
	src/libcanblf/libcanblf_la-blfstream.lo \
	src/libcanblf/libcanblf_la-blfapi.lo
libcanblf_la_OBJECTS = $(am_libcanblf_la_OBJECTS)
libcanblf_la_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) \
	$(LIBTOOLFLAGS) --mode=link $(CCLD) $(AM_CFLAGS) $(CFLAGS) \
	$(libcanblf_la_LDFLAGS) $(LDFLAGS) -o $@
libcanclg_la_LIBADD =
...
am__DEPENDENCIES_1 =
cantomat_DEPENDENCIES = libcandbc.la libcanasc.la libcanblf.la \
	libcanvsb.la libcanclg.la $(am__DEPENDENCIES_1) 
...
am__v_YACC_1 = 
SOURCES = $(libcanasc_la_SOURCES) $(libcanblf_la_SOURCES) \
	$(libcanclg_la_SOURCES) $(libcandbc_la_SOURCES) \
	$(libcanmdf_la_SOURCES) $(libcanvsb_la_SOURCES) \
	$(cantomat_SOURCES) $(dbccopy_SOURCES) $(dbcls_SOURCES) \
	$(matdump_SOURCES) $(mdftomat_SOURCES)
DIST_SOURCES = $(libcanasc_la_SOURCES) $(libcanblf_la_SOURCES) \
	$(libcanclg_la_SOURCES) $(libcandbc_la_SOURCES) \
	$(libcanmdf_la_SOURCES) $(libcanvsb_la_SOURCES) \
	$(cantomat_SOURCES) $(dbccopy_SOURCES) $(dbcls_SOURCES) \
	$(matdump_SOURCES) $(mdftomat_SOURCES)
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config.h.in AUTHORS \
	COPYING ChangeLog README TODO compile config.guess config.sub \
	depcomp install-sh ltmain.sh malloc.c missing realloc.c \
	src/libcandbc/lexer.c src/libcandbc/parser.c \
	src/libcandbc/parser.h strndup.c strnlen.c strtod.c strtok_r.c \
	ylwrap
...
ACLOCAL = ${SHELL} /Users/hanwang/Workspace/cantools-blf/missing aclocal-1.15
ALLOCA = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AS = as
AUTOCONF = ${SHELL} /Users/hanwang/Workspace/cantools-blf/missing autoconf
AUTOHEADER = ${SHELL} /Users/hanwang/Workspace/cantools-blf/missing autoheader
AUTOMAKE = ${SHELL} /Users/hanwang/Workspace/cantools-blf/missing automake-1.15
AWK = awk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2
CHECK_CFLAGS = -D_THREAD_SAFE -I/usr/local/Cellar/check/0.12.0/include
CHECK_LIBS = -L/usr/local/Cellar/check/0.12.0/lib -lcheck
CPP = gcc -E
CPPFLAGS = 
CXX = g++
CXXCPP = g++ -E
...
GLIB_CFLAGS = -I/usr/local/Cellar/glib/2.54.2/include/glib-2.0 -I/usr/local/Cellar/glib/2.54.2/lib/glib-2.0/include -I/usr/local/opt/gettext/include -I/usr/local/Cellar/pcre/8.41/include
GLIB_LIBS = -L/usr/local/Cellar/glib/2.54.2/lib -L/usr/local/opt/gettext/lib -lglib-2.0 -lintl -Wl,-framework -Wl,CoreFoundation
GREP = /usr/bin/grep
HDF5_LIB = -lhdf5
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /Users/hanwang/Workspace/cantools-blf/missing makeinfo
MANIFEST_TOOL = :
MATIO_CFLAGS = -I/usr/local/Cellar/libmatio/1.5.11/include -I/usr/local/opt/hdf5/include
MATIO_LIBS = -L/usr/local/Cellar/libmatio/1.5.11/lib -L/usr/local/opt/hdf5/lib -lmatio -lhdf5 -lz
...
ZLIB_LIBS = -lz
Z_LIB = -lz
abs_builddir = /Users/hanwang/Workspace/cantools-blf
abs_srcdir = /Users/hanwang/Workspace/cantools-blf
abs_top_builddir = /Users/hanwang/Workspace/cantools-blf
abs_top_srcdir = /Users/hanwang/Workspace/cantools-blf
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /Users/hanwang/Workspace/cantools-blf/install-sh
...
cantomat_CPPFLAGS = -I/usr/local/Cellar/libmatio/1.5.11/include -I/usr/local/opt/hdf5/include \
...
cantomat_LDADD = libcandbc.la libcanasc.la libcanblf.la libcanvsb.la \
	libcanclg.la -L/usr/local/Cellar/libmatio/1.5.11/lib -L/usr/local/opt/hdf5/lib -lmatio -lhdf5 -lz -lz $(HDF5_LIB)  \
	-lm
...
mdftomat_CPPFLAGS = -I/usr/local/Cellar/libmatio/1.5.11/include -I/usr/local/opt/hdf5/include \
	   -I$(top_srcdir)/src/libcanmdf

mdftomat_LDADD = libcanmdf.la -L/usr/local/Cellar/libmatio/1.5.11/lib -L/usr/local/opt/hdf5/lib -lmatio -lhdf5 -lz -lz $(HDF5_LIB) 
...
matdump_CPPFLAGS = -I/usr/local/Cellar/libmatio/1.5.11/include -I/usr/local/opt/hdf5/include
matdump_LDADD = -L/usr/local/Cellar/libmatio/1.5.11/lib -L/usr/local/opt/hdf5/lib -lmatio -lhdf5 -lz -lz $(HDF5_LIB) 
...
libcanmdf_CPPFLAGS = -I/usr/local/Cellar/libmatio/1.5.11/include -I/usr/local/opt/hdf5/include
libcandbc_la_CPPFLAGS = -I$(top_builddir)/src/libcandbc \
                       -I$(top_srcdir)/src/libcandbc

libcandbc_la_LDFLAGS = -no-undefined -version-info 0:24:0
libcanasc_la_CPPFLAGS = -I$(top_builddir)/src/libcanasc \
		      	       -I$(top_srcdir)/src/libcandbc \
		    		   -I$(top_srcdir)/src/cantomat \
                       -I$(top_srcdir)/src/hashtable

libcanasc_la_LDFLAGS = -no-undefined -version-info 0:24:0
...
libcanblf_la_LDFLAGS = -no-undefined -version-info 0:24:0
libcanvsb_la_CPPFLAGS = -I$(top_builddir)/src/libcanvsb \
					   -I$(top_srcdir)/src/libcandbc \
				       -I$(top_srcdir)/src/cantomat \
                       -I$(top_srcdir)/src/hashtable

libcanvsb_la_LDFLAGS = -no-undefined -version-info 0:24:0
libcanclg_la_CPPFLAGS = -I$(top_builddir)/src/libcanclg \
				       -I$(top_srcdir)/src/libcandbc \
	       		       -I$(top_srcdir)/src/cantomat \
                       -I$(top_srcdir)/src/hashtable

libcanclg_la_LDFLAGS = -no-undefined -version-info 0:24:0
libcanmdf_la_CPPFLAGS = -I$(top_builddir)/src/libcanmdf -I/usr/local/Cellar/libmatio/1.5.11/include -I/usr/local/opt/hdf5/include
libcanmdf_la_LDFLAGS = -no-undefined -version-info 0:24:0
...
src/libcanblf/$(am__dirstamp):
	@$(MKDIR_P) src/libcanblf
	@: > src/libcanblf/$(am__dirstamp)
src/libcanblf/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) src/libcanblf/$(DEPDIR)
	@: > src/libcanblf/$(DEPDIR)/$(am__dirstamp)
src/libcanblf/libcanblf_la-blfreader.lo:  \
	src/libcanblf/$(am__dirstamp) \
	src/libcanblf/$(DEPDIR)/$(am__dirstamp)
src/libcanblf/libcanblf_la-blfparser.lo:  \
	src/libcanblf/$(am__dirstamp) \
...
src/libcanblf/libcanblf_la-blfstream.lo:  \
	src/libcanblf/$(am__dirstamp) \
	src/libcanblf/$(DEPDIR)/$(am__dirstamp)
src/libcanblf/libcanblf_la-blfapi.lo: src/libcanblf/$(am__dirstamp) \
	src/libcanblf/$(DEPDIR)/$(am__dirstamp)

libcanblf.la: $(libcanblf_la_OBJECTS) $(libcanblf_la_DEPENDENCIES) $(EXTRA_libcanblf_la_DEPENDENCIES) 
	$(AM_V_CCLD)$(libcanblf_la_LINK) -rpath $(libdir) $(libcanblf_la_OBJECTS) $(libcanblf_la_LIBADD) $(LIBS)
...
mostlyclean-compile:
	...
	-rm -f src/libcanblf/*.$(OBJEXT)
	-rm -f src/libcanblf/*.lo
...
include src/libcanblf/$(DEPDIR)/libcanblf_la-blfapi.Plo
include src/libcanblf/$(DEPDIR)/libcanblf_la-blfparser.Plo
include src/libcanblf/$(DEPDIR)/libcanblf_la-blfreader.Plo
include src/libcanblf/$(DEPDIR)/libcanblf_la-blfstream.Plo
...
src/libcanblf/libcanblf_la-blfreader.lo: src/libcanblf/blfreader.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libcanblf_la_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT src/libcanblf/libcanblf_la-blfreader.lo -MD -MP -MF src/libcanblf/$(DEPDIR)/libcanblf_la-blfreader.Tpo -c -o src/libcanblf/libcanblf_la-blfreader.lo `test -f 'src/libcanblf/blfreader.c' || echo '$(srcdir)/'`src/libcanblf/blfreader.c
	$(AM_V_at)$(am__mv) src/libcanblf/$(DEPDIR)/libcanblf_la-blfreader.Tpo src/libcanblf/$(DEPDIR)/libcanblf_la-blfreader.Plo
#	$(AM_V_CC)source='src/libcanblf/blfreader.c' object='src/libcanblf/libcanblf_la-blfreader.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libcanblf_la_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o src/libcanblf/libcanblf_la-blfreader.lo `test -f 'src/libcanblf/blfreader.c' || echo '$(srcdir)/'`src/libcanblf/blfreader.c

src/libcanblf/libcanblf_la-blfparser.lo: src/libcanblf/blfparser.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libcanblf_la_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT src/libcanblf/libcanblf_la-blfparser.lo -MD -MP -MF src/libcanblf/$(DEPDIR)/libcanblf_la-blfparser.Tpo -c -o src/libcanblf/libcanblf_la-blfparser.lo `test -f 'src/libcanblf/blfparser.c' || echo '$(srcdir)/'`src/libcanblf/blfparser.c
	$(AM_V_at)$(am__mv) src/libcanblf/$(DEPDIR)/libcanblf_la-blfparser.Tpo src/libcanblf/$(DEPDIR)/libcanblf_la-blfparser.Plo
#	$(AM_V_CC)source='src/libcanblf/blfparser.c' object='src/libcanblf/libcanblf_la-blfparser.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libcanblf_la_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o src/libcanblf/libcanblf_la-blfparser.lo `test -f 'src/libcanblf/blfparser.c' || echo '$(srcdir)/'`src/libcanblf/blfparser.c

src/libcanblf/libcanblf_la-blfstream.lo: src/libcanblf/blfstream.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libcanblf_la_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT src/libcanblf/libcanblf_la-blfstream.lo -MD -MP -MF src/libcanblf/$(DEPDIR)/libcanblf_la-blfstream.Tpo -c -o src/libcanblf/libcanblf_la-blfstream.lo `test -f 'src/libcanblf/blfstream.c' || echo '$(srcdir)/'`src/libcanblf/blfstream.c
	$(AM_V_at)$(am__mv) src/libcanblf/$(DEPDIR)/libcanblf_la-blfstream.Tpo src/libcanblf/$(DEPDIR)/libcanblf_la-blfstream.Plo
#	$(AM_V_CC)source='src/libcanblf/blfstream.c' object='src/libcanblf/libcanblf_la-blfstream.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libcanblf_la_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o src/libcanblf/libcanblf_la-blfstream.lo `test -f 'src/libcanblf/blfstream.c' || echo '$(srcdir)/'`src/libcanblf/blfstream.c

src/libcanblf/libcanblf_la-blfapi.lo: src/libcanblf/blfapi.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libcanblf_la_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT src/libcanblf/libcanblf_la-blfapi.lo -MD -MP -MF src/libcanblf/$(DEPDIR)/libcanblf_la-blfapi.Tpo -c -o src/libcanblf/libcanblf_la-blfapi.lo `test -f 'src/libcanblf/blfapi.c' || echo '$(srcdir)/'`src/libcanblf/blfapi.c
	$(AM_V_at)$(am__mv) src/libcanblf/$(DEPDIR)/libcanblf_la-blfapi.Tpo src/libcanblf/$(DEPDIR)/libcanblf_la-blfapi.Plo
#	$(AM_V_CC)source='src/libcanblf/blfapi.c' object='src/libcanblf/libcanblf_la-blfapi.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libcanblf_la_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o src/libcanblf/libcanblf_la-blfapi.lo `test -f 'src/libcanblf/blfapi.c' || echo '$(srcdir)/'`src/libcanblf/blfapi.c
...
clean-libtool:
	...
	-rm -rf src/libcanblf/.libs src/libcanblf/_libs
...
distclean-generic:
	...
	-rm -f src/libcanblf/$(DEPDIR)/$(am__dirstamp)
	-rm -f src/libcanblf/$(am__dirstamp)
...
distclean: distclean-recursive
	...
	-rm -rf $(DEPDIR) src/cantomat/$(DEPDIR) src/dbccopy/$(DEPDIR) src/dbcls/$(DEPDIR) src/hashtable/$(DEPDIR) src/libcanasc/$(DEPDIR) src/libcanblf/$(DEPDIR) src/libcanclg/$(DEPDIR) src/libcandbc/$(DEPDIR) src/libcanmdf/$(DEPDIR) src/libcanvsb/$(DEPDIR) src/matdump/$(DEPDIR) src/mdftomat/$(DEPDIR)
	-rm -f Makefile
